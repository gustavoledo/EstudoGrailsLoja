...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'usuario.label', default: 'Usu�rio')}" />
        <title>
	                ...
	                <fieldset>
	                	<legend>Dados</legend>
							   ...
							   <g:if test="${session.usuario.perfil == Perfil.MASTER || session.usuario.hasFilial}">
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="inativo" class="obrigatorio"> 
										<g:message code="usuario.inativo.label" default="Inativo" />	                                 
									  </label>
			                    	  <g:checkBox name="inativo" value="${usuarioInstance?.inativo}" />
	                               </li>
	                           </ol>
