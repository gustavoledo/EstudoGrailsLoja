...
<html>
    ...
    <body class="tundra">
		...
		<g:render template="/layouts/flashErrorInclude" model="[modelInstance: aluminioInstance]"/>
         ...
         <div class="gedigblue">
	           ...
	           <g:form method="post"  enctype="multipart/form-data">
	               	...
	               	<g:hiddenField name="version" value="${aluminioInstance?.version}" />
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="secao" class="obrigatorio"> 
										<g:message code="aluminio.secao.label" default="Seção" />	                                 
									  </label>
	                                  <g:select name="secao.id" from="${loja.Secao.findAllByLoja(loja)}" optionKey="id" value="${aluminioInstance?.secao?.id}"  />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="nome" class="obrigatorio"> 
										<g:message code="aluminio.nome.label" default="Nome" />	                                 
									  </label>
	                                  <g:textField name="nome" maxlength="80" value="${aluminioInstance?.nome}" />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="tamanho" class="obrigatorio"> 
										<g:message code="aluminio.tamanho.label" default="Tamanho" />	                                 
									  </label>
	                                  <g:numberTextField name="tamanho" precision="2" size="10" maxlength="10" value="${fieldValue(bean: aluminioInstance, field: 'tamanho')}" />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="cor" class="obrigatorio"> 
										<g:message code="aluminio.cor.label" default="Cor" />	                                 
									  </label>
	                                  <g:select name="cor.id" from="${loja.Cor.findAllByLoja(loja)}" optionKey="id" value="${aluminioInstance?.cor?.id}"  />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="precoUnitarioCompra" class="obrigatorio"> 
										<g:message code="aluminio.precoUnitarioCompra.label" default="Preço Unitário de Compra" />	                                 
									  </label>
	                                  <g:numberTextField name="precoUnitarioCompra" onblur="calculaPrecoUnitario()" precision="2" size="10" maxlength="10" value="${fieldValue(bean: aluminioInstance, field: 'precoUnitarioCompra')}" />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="precoUnitario" class="obrigatorio"> 
										<g:message code="aluminio.precoUnitario.label" default="Preço Unitário" />	                                 
									  </label>
	                                  <g:numberTextField name="precoUnitario" precision="2" size="10" maxlength="10" value="${fieldValue(bean: aluminioInstance, field: 'precoUnitario')}" />
	                               </li>
	                           </ol>
