...
<html>
    ...
    <body class="tundra">
		...
		<g:render template="/layouts/flashErrorInclude" model="[modelInstance: kitInstance]"/>
         ...
         <div class="gedigblue">
	           ...
	           <g:form method="post"  enctype="multipart/form-data">
	               	...
	               	<g:hiddenField name="version" value="${kitInstance?.version}" />
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="secao" class="obrigatorio"> 
										<g:message code="kit.secao.label" default="Seção" />	                                 
									  </label>
	                                  <g:select name="secao.id" from="${loja.Secao.findAllByLoja(loja)}" optionKey="id" value="${kitInstance?.secao?.id}"  />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="nome" class="obrigatorio"> 
										<g:message code="kit.nome.label" default="Nome" />	                                 
									  </label>
	                                  <g:textField name="nome" maxlength="80" value="${kitInstance?.nome}" />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="cor" class="obrigatorio"> 
										<g:message code="kit.cor.label" default="Cor" />	                                 
									  </label>
	                                  <g:select name="cor.id" from="${loja.Cor.findAllByLoja(loja)}" optionKey="id" value="${kitInstance?.cor?.id}"  />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="precoUnitarioCompra" class="obrigatorio"> 
										<g:message code="kit.precoUnitarioCompra.label" default="Preço Unitário de Compra" />	                                 
									  </label>
	                                  <g:numberTextField name="precoUnitarioCompra" onblur="calculaPrecoUnitario()" precision="2" size="10" maxlength="10" value="${fieldValue(bean: kitInstance, field: 'precoUnitarioCompra')}" />
	                               </li>
	                           </ol>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="precoUnitario" class="obrigatorio"> 
										<g:message code="kit.precoUnitario.label" default="Preço Unitário" />	                                 
									  </label>
	                                  <g:numberTextField name="precoUnitario" precision="2" size="10" maxlength="10" value="${fieldValue(bean: kitInstance, field: 'precoUnitario')}" />
	                               </li>
	                           </ol>
