			        			...
			        			<ol>
			                	   <li>
	                                 <label for="secao" class="obrigatorio"> 
										<g:message code="vidro.secao.label" default="Se��o" />	                                 
									  </label>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="precoUnitarioCompra" class="obrigatorio"> 
										<g:message code="vidro.precoUnitarioCompra.label" default="Preco Unit�rio de Compra" />	                                 
									  </label>
			        			...
			        			<ol>
			                	   <li>
	                                 <label for="precoUnitario" class="obrigatorio"> 
										<g:message code="vidro.precoUnitario.label" default="Pre�o Unit�rio" />	                                 
									  </label>
